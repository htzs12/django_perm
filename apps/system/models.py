...
# Menu: 菜单管理, 用来储存系统可用的URL
# Role: 角色组，通过外检关联Menu， 角色组中的用户将继承Role关联菜单的访问权限
# Structure: 组织架构，包含单位和部门
...
class Menu(models.Model):
    ...
    url = models.CharField(max_length=128, unique=True, null=True, blank=True, verbose_name='网址')
...
class UserProfile(AbstractUser):
    ...
    department = models.ForeignKey('Structure', null=True, blank=True,
